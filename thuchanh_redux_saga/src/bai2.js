...
const Bai2 = ({ navigation }) => { // Capitalized component name as convention
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable onPress={() => navigation.navigate('Bai3')} style={styles.pre}>
...
export default Bai2; // Capitalize on export for consistency
